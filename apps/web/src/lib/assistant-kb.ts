...
const LANDING_ENTRIES: AssistantEntry[] = [
  ...
  },
  {
    ...
    answer: {
      es: "Sí en Pro y Premium. Inventario retail (vitrina) e insumos de uso interno (g/ml): definís la receta del servicio, al cobrar se descuenta; caja puede ajustar ± con motivo. No mezcles el shampoo de venta con el tinte de piso.",
      en: "Yes on Pro and Premium. Retail inventory and internal supplies (g/ml): set the service recipe, checkout deducts it; POS can adjust ± with a reason. Don’t mix shelf shampoo with floor tint.",
    },
  },
  {
    id: "landing-stylist",
  ...
  },
  {
    ...
    answer: {
      es: "Precios de lanzamiento: Básico C$699 (~$19) agenda y catálogo; Pro C$1,299 (~$35) + POS, inventario, insumos, piso del estilista, contabilidad y sitio; Premium C$1,999 (~$55) + ilimitados y multi-sucursal.",
      en: "Launch pricing: Basic C$699 (~$19) schedule and catalog; Pro C$1,299 (~$35) + POS, inventory, consumables, stylist floor, accounting and site; Premium C$1,999 (~$55) + unlimited and multi-branch.",
    },
    adminHref: "/billing",
