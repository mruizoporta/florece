...
class AppointmentCreateComponent extends Component
{
    ...
    {
        $setting = TenantDataCache::setting() ?? new Setting;
        $tenant = Tenant::current();
        $catalog = TenantDataCache::bookingCatalog($tenant);

        return view('livewire.frontend.appointment-create-component', [
            'setting' => $setting,
            ...
            'title' => ($setting->company_name ? $setting->company_name.' · ' : '').__('app.page.title.appointment_book'),
        ]);
    }
}
