                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <img class="w-16"
                                                        src="{{ asset('storage/logo/300/', $setting->logo) }}"
                                                    ...
                                                    <div class="space-y-4">
                                                        <h1 class="text-4xl fw-800"
                                                            ...
                                                            align="left">
                                                            {{ __('app.mail.appointment.headline', ['name' => ucfirst($appointment->customer->user->name)]) }}
                                                        </h1>
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">@php($__aptStart = \Carbon\Carbon::parse($appointment->start_time)->locale(app()->getLocale())){{ __('app.mail.appointment.line_attending', ['employee' => $appointment->employee->name, 'datetime' => $__aptStart->isoFormat(__('app.mail.appointment.datetime_iso_format'))]) }}
                                                        </p>
                                                        <table class="s-4 w-full" role="presentation" border="0"
                                                            cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <h3 class="text-center"
                                                                        ...
                                                                        align="center">Detalles de la agenda
                                                                    </h3>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-right"
                                                                                    ...
                                                                                    {{ $setting->currency_symbol }}{{ number_format($service->item->price, 2) }}
                                                                                </td>
                                                                            </tr>
                                                                            @endforeach
                                                                        </tbody>
                                                                    ...
                                                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        Si deseas cancelar tu agenda debes realizarlo a través de nuestro sitio web.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
