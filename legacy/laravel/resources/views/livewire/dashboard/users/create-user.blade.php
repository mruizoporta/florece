<div>
    <div x-data="{ open: false }"
         ...
         @close-user-create-modal.window="open = false"
         @keydown.escape.window="open = false">

        {{-- Overlay + panel (Tailwind — compatible con dashboard-new sin Bootstrap) --}}
        <div x-show="open"
             x-cloak
             ...
             class="fixed inset-0 z-[70] flex items-center justify-center bg-brand-ink/40 backdrop-blur-sm p-4"
            ...
            <div x-show="open"
                ...
                <form wire:submit="save">
                    <div class="px-6 pt-5 pb-4 border-b border-brand-blush-light/60 flex items-start justify-between gap-4">
                        <h2 id="user-create-title" class="font-serif text-lg font-semibold text-brand-ink leading-tight">
                    ...
                    <div class="px-6 py-5 space-y-4">
                        <div>
                            <label for="user-create-name" class="block text-xs font-semibold uppercase tracking-wide text-brand-ink-muted mb-1.5">Nombre</label>
                        ...
                        <div>
                            <label for="user-create-email" class="block text-xs font-semibold uppercase tracking-wide text-brand-ink-muted mb-1.5">Correo</label>
                            <input id="user-create-email"
                                   type="email"
                        ...
                        <div>
                            <label for="user-create-password" class="block text-xs font-semibold uppercase tracking-wide text-brand-ink-muted mb-1.5">Contraseña</label>
                            <input id="user-create-password"
                                   type="password"
